...
public class GridSeranggaAdapter extends RecyclerView.Adapter<GridSeranggaAdapter.GridViewHolder> {
    ...
    public GridSeranggaAdapter(Context context) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_serangga, parent, false);
